...
export default function AboutPage() {
  ...
  const aboutData = usePageContent("about", {
    ...
    subheading: "afriCrew is Kenya's premier tech-enabled staffing platform. We bridge the gap between event organizers and background-checked, corporate-ready staff.",
    metaTitle: "About Us — afriCrew",
    ...
    customFields: {
      ...
      ourJourneyIntro: "For years, event organizers across Kenya faced last-minute crew no-shows, unvetted staff, and inconsistent protocol standards. afriCrew was launched to bring technology, trust, and accountability to event logistics.",
      ...
      ourJourneyImageAltText: "afriCrew Team at Conference",
      ...
      leadershipHeadingHighlight: "afriCrew",
